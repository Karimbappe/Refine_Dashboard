...
const Profile = ({ type, name, avatar, email, properties }: ProfileProps) => (
    <Box>
        ...
        <Box mt="20px" borderRadius="15px" padding="20px" bgcolor="#FCFCFC">
            ...
            >
                <img
                    src="https://t3.ftcdn.net/jpg/01/62/97/84/360_F_162978432_KsCQQYZSVZbZABmgVkklnFgKnKdEj2Ku.jpg"
                    width={340}
                    height={320}
                    alt="abstract"
                                ...
                                <Stack gap="15px">
                                    ...
                                    >
                                        ...
                                        <Typography
                                            ...
                                            color="#11142D"
                                        >
                                            116 Rue de Faubourg Saint-Martin, 75010 Paris
                                        </Typography>
                                    </Box>
                                </Stack>
